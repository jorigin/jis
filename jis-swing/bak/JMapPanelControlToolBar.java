...
//IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII
  ...
  protected void initGUI(){
    ...
    this.zoomInButton.setIcon(new ImageIcon(getClass().getClassLoader().getResource("icon/map_zoom_plus.png")));
    ...
    this.zoomOutButton.setIcon(new ImageIcon(getClass().getClassLoader().getResource("icon/map_zoom_minus.png")));
    ...
    this.panButton.setIcon(new ImageIcon(getClass().getClassLoader().getResource("icon/map_pan.png")));
    ...
    this.selectButton.setIcon(new ImageIcon(getClass().getClassLoader().getResource("icon/map_select.png")));
    ...
    this.fitButton.setIcon(new ImageIcon(getClass().getClassLoader().getResource("icon/map_zoom_fit.png")));
