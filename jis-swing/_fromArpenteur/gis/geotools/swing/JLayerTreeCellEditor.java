...
public class JLayerTreeCellEditor extends DefaultTreeCellEditor {
  ...
  public Component getTreeCellEditorComponent(JTree tree, Object value,
      boolean isSelecteded, boolean expanded, boolean leaf, int row) {
    ...
    if (dmtcr.getUserObject() instanceof MapLayer){
      ...
      checkBox.addItemListener(new ItemListener(){
        ...
        public void itemStateChanged(ItemEvent e) {
          currLayer.setVisible(((JCheckBox)e.getSource()).isSelecteded());  
        }});
      ...
      if (style != null){
        ...
        panel = (JPanel) super.renderer.getTreeCellRendererComponent(tree, value, isSelecteded, expanded, leaf, row, true);
      }
